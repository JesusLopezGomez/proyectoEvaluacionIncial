//Recuperamos varios elementos de nuestro html calculadora imc
...
generar.addEventListener(`click`,function(){
    ...
    if((isNaN(numPeso.value) || isNaN(numAltura.value)) || (numPeso.value == "" || numAltura.value == "")){  //Si la altura o el peso no es un número entraría por este if.
       ...
       resultadoText.textContent = "Su Índice de masa corporal es: " + (numPeso.value/((alturaMetros)*alturaMetros)).toFixed(2); //Le ponemos el resultado en el lugar que he seleccionado.
       resultadoText.style.color = "black";
    }
})
